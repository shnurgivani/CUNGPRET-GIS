...
w.poly(parts=[[[1,3],[5,3], [5,2],[1,2],[1,3]]],shapeType=shapefile.POLYLINE) #titik koordinat
w.poly(parts=[[[1,6],[5,6], [5,9],[1,9],[1,6]]],shapeType=shapefile.POLYLINE) #titik koordinat
